...
class particles
{
 ...
 public:
  ...
  inline void add(double* xAdd , double* yAdd, double* vxAdd , double* vyAdd, int Np)
  {
  ...
  inline void addFlux(double time, double y0 , double y1 , double density, double vx_bdy, double vy_bdy)
  {
    ...
    int np_size = (int) Np + 1;
    double* xAdd ;  xAdd = new double[np_size];    
    double* yAdd ;  yAdd = new double[np_size];
    double* vxAdd; vxAdd = new double[np_size];  
    double* vyAdd; vyAdd = new double[np_size];
    ...
    add(xAdd , yAdd, vxAdd , vyAdd, np_size + 1);
